...
/**
 * RecyclerView列表的Item事件，item点击事件，item长按事件
 */
public class RecyclerViewItemClickSupport {
    private final RecyclerView mRecyclerView;
    private OnItemClickListener mOnItemClickListener;//列表Item点击事件
    private OnItemLongClickListener mOnItemLongClickListener;//列表Item长按事件
